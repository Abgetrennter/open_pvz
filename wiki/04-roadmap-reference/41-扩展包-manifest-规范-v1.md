...
> 这份文档用于把 [扩展系统总体规划-v1](38-扩展系统总体规划-v1.md)、[素材包系统设计草案](39-素材包系统设计草案.md) 和 [扩展包边界与依赖规则-v1](40-扩展包边界与依赖规则-v1.md) 中已经达成的共识，进一步收敛成统一的 manifest 规范。它回答的不是“当前最小 `extension.json` 里有什么字段”，而是“后续四类核心包应共享哪些元字段、不同包类型还需要哪些专属字段，以及加载器和校验器应如何围绕这份规范演进”。
