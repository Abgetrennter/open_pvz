...
Open PVZ 扩展体系实验场：8 个包（2 内容 + 6 守卫/探测），109 内容文件，通过 `ExtensionPackCatalog` 加载。
...
| phase5_chaos_pack | phase5_chaos_pack | yes | trusted_runtime | resources, effects | content | 70 |
...
| slot | 使用包数 | 包列表 |
|------|---------|--------|
| resources | 5 | minimal_chaos, my_pack, phase5_chaos, registry_probe, slot_guardrail |
| effects | 3 | phase5_chaos, phase5_guardrail, registry_probe |
