...
static func create(
	...
	event_data.core = {
		...
		"source_projectile_template_id": _extract_projectile_template_id(source_node),
		"target_projectile_template_id": _extract_projectile_template_id(target_node),
...
static func _extract_projectile_template_id(node: Node) -> StringName:
	if node == null:
		return StringName()
