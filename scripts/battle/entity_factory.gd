...
func instantiate_spawn_entry(spawn_entry: Resource, position: Vector2) -> Dictionary:
	...
	var projectile_flight_profile: Resource = _resolve_projectile_flight_profile(spawn_entry, entity_template)
	...
	return {
		...
		"trigger_instances": build_runtime_triggers(entity_kind, entity_template, params, projectile_flight_profile),
	}
...
func build_runtime_triggers(
	...
	match entity_kind:
		&"plant":
			return _build_plant_runtime_triggers(template, params, projectile_flight_profile)
		&"zombie":
...
func _build_plant_runtime_triggers(template, params: Dictionary, projectile_flight_profile: Resource) -> Array:
